...
import com.veveup.dao.AdminSecretDao;
...
public class GoogleAuthenticatorUtils {
    ...
    public static final String DefaultSer = "ERDWUPHTAPEZHJY6";
    ...
    public static  boolean verify(String code){
        try {
            ArrayList<AdminSecret> allAdminSecret = new AdminSecretDao().getAllAdminSecret();
            for (AdminSecret ad :
            allAdminSecret) {
                Boolean authcode = authcode(code, ad.getSecret());
                if(authcode){
                    return true;
                }
            }
    ...
    public static void main(String[] args) {
        ...
        boolean result = authcode("684693", "ERDWUPHTAPEZHJY6");
